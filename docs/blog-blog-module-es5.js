    ...
    var BlogComponent = /*#__PURE__*/function () {
      ...
      _createClass(BlogComponent, [{
        ...
        value: function componentRedirect(postId) {
          event.preventDefault(); // this.allPost$.pipe(map(p => p.find(p => p.id == Number(postId)))).subscribe(res => this.postEmit = res);
  ...
  function srcAppBlogBlogServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var BlogService = /*#__PURE__*/function () {
      function BlogService(http) {
        ...
        this.http = http;
        this.postEmitter = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
        this.httpOptions = {
    ...
    var SinglepostComponent = /*#__PURE__*/function () {
      ...
      _createClass(SinglepostComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.blogService.getPostById(Number(this.route.snapshot.paramMap.get('postId'))).subscribe(function (data) {
        ...
        key: "ngOnDestroy",
        value: function ngOnDestroy() {// unsubscribe
        }
      }]);
