...
let UserService = class UserService {
    constructor(http) {
        ...
        this.myAppUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].mockendUrl;
        this.myApiUrl = '/users';
    }
    errorHandler(error) {
        let errorMessage = '';
